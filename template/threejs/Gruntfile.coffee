module.exports = (grunt) ->
    grunt.initConfig
        ...
        watch:
            app:
                files: ['Gruntfile.coffee', 'source/coffee/**/*coffee', 'source/sass/*.sass']
        ...
        sass:
            ...
            app:
                files:
                    'deploy/css/app.css': 'source/sass/style.sass'
        ...
        uglify:
            ...
            vendors:
                files:
                    'deploy/js/vendors.min.js': [
                        'source/_static/vendors/dat.gui.min.js',
                        'source/_static/vendors/Stats.js',
                        'source/_static/vendors/threex.renderstats-custom.js',
                        'source/_static/vendors/threejs/three.min.js',
                    ]
